            ...
            <div class="modal-body">
                ...
                @csrf
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name" id="exampleInputName" value="{{$item->nama_kategori}}" required>
                    </div>
            </div>
            <div class="modal-footer">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="/admin/category/destroy/{{$item->id}}"><button type="button" class="btn btn-danger"><i class="fa fa-trash"></i> Delete</button></a>
            </div>
        </div>
    </div>
</div>
