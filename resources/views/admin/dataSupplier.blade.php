        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/admin/supplier/store" method="post">
                    @csrf
                    <div class="mb-3">
                        <label for="InputName" class="form-label">Nama Supplier</label>
...
<div class="modal fade" id="modalEdit{{$item->id}}">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/admin/supplier/update/{{$item->id}}" method="post">
                @csrf
                    <div class="mb-3">
                        <label for="InputName" class="form-label">Nama Supplier</label>
                        <input type="text" class="form-control" id="InputName" name="name" value="{{$item->nama_supplier}}" required>
                    </div>
                    <div class="mb-3">
                        <label for="alamat" class="form-label">Alamat</label>
                        <textarea class="form-control" name="alamat" id="alamat" cols="15" rows="5" required>{{$item->alamat}}</textarea>
                    </div>
                    <div class="mb-3">
                        <label for="kontak" class="form-label">Kontak</label>
                        <input type="number" class="form-control" id="kontak" name="kontak" value="{{$item->kontak}}" required>
                    </div>
            </div>
            <div class="modal-footer">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="/admin/supplier/destroy/{{$item->id}}"><button type="button" class="btn btn-danger"><i class="fa fa-trash"></i> Delete</button></a>
            </div>
        </div>
    </div>
</div>
